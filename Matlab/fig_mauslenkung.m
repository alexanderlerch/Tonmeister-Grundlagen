...
ylabel('20log(xs/F)','FontSize',12,'FontWeight','demi'),
title('Membranauslenkung in Abhängigkeit der Frequenz','FontSize',14,'FontWeight','bold'), 
set(gca,'XTick',[0 .5 1 1.5 2]),
text(.85, 7, '\downarrow \eta','FontSize',12)
%set(gca,'XTickLabel',{''}),
